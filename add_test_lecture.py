...
def add_test_data():
    ...
    lecture_data = [
        {"title": "정치의 기초", "difficulty": 3, "topic": "정치 | 경제",
            "image": "images/economy.png", "description": "정치의 기본 개념을 학습합니다."},
        {"title": "문학 101", "difficulty": 2, "topic": "문학",
            "image": "images/literature.png", "description": "문학 분석의 기초를 학습합니다."},
        {"title": "기초 수학", "difficulty": 4, "topic": "수학 | 과학",
            "image": "images/math.png", "description": "수학의 기본 개념을 학습합니다."},
        {"title": "과학 혁명", "difficulty": 5, "topic": "수학 | 과학",
            "image": "images/math.png", "description": "과학 혁명의 주요 사건을 학습합니다."},
        {"title": "시사 문제", "difficulty": 3, "topic": "시사",
            "image": "images/event.png", "description": "현재 시사 문제를 분석합니다."},
        {"title": "고급 경제학", "difficulty": 4, "topic": "정치 | 경제",
            "image": "images/economy.png", "description": "고급 경제 이론을 학습합니다."},
        {"title": "현대 문학", "difficulty": 3, "topic": "문학",
            "image": "images/literature.png", "description": "현대 문학 작품을 분석합니다."},
        {"title": "응용 수학", "difficulty": 5, "topic": "수학 | 과학",
            "image": "images/math.png", "description": "수학적 원리의 응용을 학습합니다."},
        {"title": "기술 발전", "difficulty": 4, "topic": "수학 | 과학",
            "image": "images/math.png", "description": "최근 기술 발전을 학습합니다."},
        {"title": "국제 문제", "difficulty": 3, "topic": "시사",
            "image": "images/event.png", "description": "국제 시사 문제를 분석합니다."},
